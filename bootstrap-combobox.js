	...
	Combobox.prototype = {
		...
		template : function() {
			if (this.options.bsVersion == '2') {
				...
				return '<div class="combobox-container"> <input type="hidden" /> <div class="input-group" style="width:100%"> <input type="text" autocomplete="off" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret" /> <span class="fa fa-times" /> </span> </div> </div>'
			}
		}
